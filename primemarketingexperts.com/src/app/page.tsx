        ...
        <div className="flex w-full h-full absolute top-0 left-0 z-50 items-center bg-black/40">
          <div className="container mx-auto px-6 xl:px-0">
            <div className="max-w-[800px]">
              <h1 className="font-poppins font-bold text-4xl md:text-[54px] leading-[1.15] uppercase text-white drop-shadow-sm tracking-wide">
                Driving Excellence With <br className="hidden md:block" /> Superior Marketing <br className="hidden md:block" /> Solutions
              </h1>
              <div className="mt-8 text-white text-lg font-light leading-relaxed max-w-[650px] drop-shadow-sm">
              ...
              <Link href="/marketing-services">
                <div className="py-4 px-8 bg-gradient-to-r from-[rgb(249,115,22)] to-[rgb(234,88,12)] inline-block rounded text-white font-bold text-base mt-10 hover:shadow-lg transition-all shadow-md">
                  Learn More
                </div>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-5">
            {displayedServices.map((service, i) => (
              <div key={i} className="bg-white cursor-pointer hover:text-black p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-xl transform transition duration-500 hover:scale-105 flex flex-col h-full group">
                <div className="flex items-center justify-center mb-6">
                  <div className="p-4 bg-orange-50 rounded-full group-hover:bg-orange-100 transition-colors">
                    <ServiceIcon iconName={service.icon} className="text-orange-600 w-[48px] h-[48px]" />
                  </div>
                </div>
                <h4 className="text-xl font-bold mb-3 text-center text-gray-900 group-hover:text-orange-600 transition-colors">{service.title}</h4>
                <p className="text-gray-600 text-sm leading-relaxed text-center mb-6 flex-grow">{service.description}</p>
                <div className="flex justify-center mt-auto">
                  <Link href={`/services/${service.slug}`}>
                    <button className="relative inline-flex items-center justify-center px-6 py-2 text-orange-600 font-bold text-sm tracking-wide uppercase group-hover:bg-orange-50 rounded-full transition-all">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link key={i} href={industry.href} className="no-underline group">
                <div className="rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer h-full hover:border-orange-200">
                  <div className="flex items-center p-8">
                    <span className="text-4xl mr-6 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">{industry.icon}</span>
                    <h4 className="text-lg font-bold text-gray-800 group-hover:text-orange-600 transition-colors">{industry.title}</h4>
                  </div>
                </div>
              </Link>
            ))}
